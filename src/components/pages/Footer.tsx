        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 relative">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              ...
              <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors focus-ring" onClick={() => setCurrentPage("community")}>
                <Users className="w-3.5 h-3.5" /> Community Forum
              </button>
            </div>
          </div>
