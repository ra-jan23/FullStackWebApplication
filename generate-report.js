...
function buildAppendices() {
  ...
  const apiRows = [
    ...
    ["GET/POST", "/api/chat", "AI chat endpoint (GLM 4.5 Air via OpenRouter, multi-turn)"],
    ["GET/POST", "/api/predictions", "Fetch matches / Generate AI prediction (GLM 4.5 Air via OpenRouter)"],
    ["GET/POST", "/api/quiz", "Fetch quiz state / Generate AI quiz questions (GLM 4.5 Air via OpenRouter)"],
  ...
  const techRows = [
    ...
    ["AI - Language Model", "GLM 4.5 Air via OpenRouter", "Chat, predictions, quiz"],
    ["AI - Vision Model", "z-ai-web-dev-sdk (VLM)", "Formation detection"],
    ["AI - LLM SDK", "OpenAI SDK 6", "OpenRouter API communication"],
  ...
  return [
    ...
    bodyParagraph("The application exposes twenty-one RESTful API routes through Next.js API Route handlers, covering authentication, data CRUD, AI features, and real-time event retrieval."),
